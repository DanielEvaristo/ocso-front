...
export default async function FormNewLocation({
  ...
  return (
    ...
    >
      ...
      ></Input>
      <Input defaultValue= {foundLocation?.locationLatLng[0].toString()} label="Latitud" placeholder="-120" name="locationLat"></Input>
      <Input defaultValue= {foundLocation?.locationLatLng[1].toString()} label="Longitud" placeholder="20" name="locationLng"></Input>
      <SelectManager
